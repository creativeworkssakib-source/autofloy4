-- Drop and recreate the function to delete all user data properly
...
BEGIN
  ...
  DELETE FROM shop_sale_items WHERE user_id = target_user_id;
  DELETE FROM shop_sales WHERE user_id = target_user_id;
  DELETE FROM shop_purchase_items WHERE user_id = target_user_id;
