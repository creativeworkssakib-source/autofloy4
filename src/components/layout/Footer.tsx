      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4 lg:gap-6">
          ...
          <div className="col-span-2">
            ...
            <p className="text-white/70 text-[11px] mb-3 max-w-xs leading-relaxed">
            ...
            <div className="flex gap-1.5">
              {displaySocialLinks.map((social) => (
                <a
                  ...
                  className="w-7 h-7 rounded-md bg-white/10 hover:bg-primary/80 flex items-center justify-center transition-colors duration-200"
                >
          ...
          {/* Product Links */}
          <div>
            <h3 className="font-semibold text-white text-xs mb-2">{t("footer.product")}</h3>
            <ul className="space-y-1">
              {footerLinks.product.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.href}
                    className="text-white/70 hover:text-primary transition-colors text-[11px]"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          {/* Company Links */}
          <div>
            <h3 className="font-semibold text-white text-xs mb-2">{t("footer.company")}</h3>
            <ul className="space-y-1">
          ...
          {/* Resources Links */}
          <div>
            <h3 className="font-semibold text-white text-xs mb-2">{t("footer.resources")}</h3>
            <ul className="space-y-1">
          ...
          {/* Legal Links */}
          <div>
            <h3 className="font-semibold text-white text-xs mb-2">{t("footer.legal")}</h3>
            <ul className="space-y-1">
        ...
        <div className="mt-4 pt-4 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-2">
          <div className="flex flex-wrap justify-center md:justify-start gap-3 text-[11px] text-white/70">
