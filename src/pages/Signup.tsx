...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      {/* Right Side - Form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 overflow-y-auto bg-background">
        <motion.div
        ...
        >
          ...
          <Link to="/" className="lg:hidden flex items-center gap-2 mb-8">
            ...
            <span className="text-xl font-bold text-foreground">{settings.company_name}</span>
          </Link>

          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-2 text-foreground">Create your account</h2>
          ...
          {/* Google OAuth */}
          <Button variant="outline" className="w-full mb-6 border-border bg-card text-foreground hover:bg-muted" size="lg">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 bg-card border-border text-foreground ${emailError ? 'border-destructive focus-visible:ring-destructive' : ''}`}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className={`pl-10 pr-10 bg-card border-border text-foreground ${confirmPasswordError ? 'border-destructive focus-visible:ring-destructive' : ''}`}
